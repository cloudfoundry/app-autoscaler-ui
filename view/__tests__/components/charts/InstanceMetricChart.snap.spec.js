...
const startTime = moment.tz(parseInt(metricsData.resources[0].collected_at / 1000000), TestConstants.timezone)
const endTime = moment.tz(parseInt(metricsData.resources[metricsData.resources.length - 1].collected_at / 1000000), TestConstants.timezone)
const props = {
  selectedIndex: 0,
